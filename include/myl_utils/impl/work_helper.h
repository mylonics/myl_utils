...
/** @brief Created a work object, timer object, work function and timer function. Work will by called by the system work queue once timer has expired. Timer needs to be started by calling
 * work_start()
 *
 *
...
/** @brief Created a delayed work object, timer object, work function and timer function. Work will by called by the system work queue once timer has expired. Timer needs to be started by calling
 * work_start()
 *
 *
 * @param work name of work item.
